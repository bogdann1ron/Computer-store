...
namespace GameStore.UnitTests
{
    ...
    public class GameTest
    {
        ...
        public void Can_Create_Categories()
        {
            ...
            mock.Setup(m => m.Games).Returns(new List<Game>
            {
                new Game { GameId = 1, Name = "Игра1", Category="Комплектующие для ПК"},
                new Game { GameId = 2, Name = "Игра2", Category="Компьютерная периферия"},
                new Game { GameId = 3, Name = "Игра3", Category="ПК"},
                new Game { GameId = 4, Name = "Игра4", Category="Принадлежности для ноутбуков"},
            });
            ...
            Assert.AreEqual(results[0], "Принадлежности для ноутбуков");
            Assert.AreEqual(results[1], "Компьютерная периферия");
            Assert.AreEqual(results[2], "ПК");
        }
        [TestMethod]
        public void Indicates_Selected_Category()
        {
            ...
            {
                new Game { GameId = 1, Name = "Игра1", Category="Компьютерная периферия"},
                new Game { GameId = 2, Name = "Игра2", Category="ПК"}
            });
